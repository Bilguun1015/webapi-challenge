...
- [ ] Mention two parts of Express that you learned about this week.
    - It is a server framework for Node.js and everything in Express is a middleware.
- [ ] Describe Middleware?
    - Middleware is functions that adds features and executes in an order.
- [ ] Describe a Resource?
    - Everything is a resource that is accessible via a unique URI.
- [ ] What can the API return to help clients know if a request was successful?
    - API can return status codes back to clients.
- [ ] How can we partition our application into sub-applications?
    - We can use server.use() to partition our end points into different files.
## Project Setup
